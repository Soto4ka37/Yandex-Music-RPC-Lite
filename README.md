...
P.S. Из-за ограничений API отображение времени трека не зависит от положения вашего плеера, если вы поставите трек на паузу RPC продолжит работать "проигнорировав" это.
В следующем обновлении сделаю возможность отключить время
